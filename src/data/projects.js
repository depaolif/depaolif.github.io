const ProjectData = [
  ...
  },
  {
    ...
    "description": "Koko is a music discovery application that utilizes Spotify’s API to allow users to search for songs, add reviews and up/down vote other users’ reviews. The application leverages a users’ voting data to provide them with a dashboard of curated suggestions, as well as views for the songs and artists trending across the site. Every review is given a reliability rating based on other users' upvoting or downvoting of that review, leading to weighted reviews. Highly rated reviews are thereby given more weight in determining top songs and artists for a given period.",
